...
@property (nonatomic, strong) JLPopupView *minimumPopupView;
@property (nonatomic, strong) JLPopupView *maximumPopupView;
@property (nonatomic, readonly) CGRect maxThumbRect;
@property (nonatomic, readonly) CGRect minThumbRect;
